@echo off
REM This script builds ABCNote after configure-msvc-qt.cmd has generated build-msvc.
...
if not exist "%BUILD_DIR%\CMakeCache.txt" call "%SCRIPT_DIR%configure-msvc-qt.cmd"
if errorlevel 1 exit /b %errorlevel%

REM Build every target in the configured build tree.
